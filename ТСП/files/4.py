...
class MainWindow(QtGui.QWidget):
	def __init__(self, parent=None):
		...
		title = QtGui.QLabel('Выберите пример:')
		title.setAlignment(QtCore.Qt.AlignCenter)
		vbox.addWidget(title)
		
		# Создание кнопок
		names = ['1 пример', '2 пример', '3 пример']
	...
	# Функция, вызываемая по клику на кнопку. Явный case (Nt=4)
	def buttonClicked(self,bId):
		...
		if 1==bId:
			...
			command = '/usr/bin/python3 ./example3.py'
